...
const Testimonials = () => {
    ...
    return (
        <section className='overflow-visible flex flex-col gap-12 items-center py-24 md:px-6 relative  '>
            <header className="container max-w-6xl w-full">
                <div className="flex flex-col w-full md:items-end flex-1 ">
                    ...
                    <h1 className='mb-4 md:self-end text-5xl md:text-6xl [&>*]:font-display  [text-shadow:0_2px_12px_rgba(174,207,242,.44)]'> <span className='bg-clip-text text-transparent bg-gradient-to-b from-zinc-400 from-10% to-55% to-white' >Beyond expectations</span></h1>
            ...
            >
                <CarouselContent>
                    {testimonialData.map((testimonial, index) => (
                        <CarouselItem key={index} className='basis-1/1 md:basis-1/2 xl:basis-1/3  py-1 flex justify-center'>
